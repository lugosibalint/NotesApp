...
* **Objektumorientáltság:** A rendszer absztrakt ősosztályt (Note) használ, amelyből a konkrét jegyzettípusok leszármazott osztályokként deklarálhatóak, ezt egy grafikus felületen keresztül végezhetjük.
...
Használja a menüsort új jegyzet létrehozásához, válassza ki a kívánt típust, majd a mentés gombbal eltárolhatja.
